...
Our system prompt used for training classification expert is in Figure~\ref{app:fig:sys_prompt}
...
\begin{minted}[framesep=2mm, baselinestretch=1.2, bgcolor=verylightgray, fontsize=\footnotesize]{python}
