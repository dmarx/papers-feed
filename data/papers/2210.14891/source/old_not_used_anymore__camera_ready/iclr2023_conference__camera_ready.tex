...
\includegraphics[width=.22\textwidth]{figures/rl/connect_four/connect_four__compute.png}
\includegraphics[width=.22\textwidth]{figures/rl/connect_four/connect_four__data.png}
\includegraphics[width=.22\textwidth]{figures/rl/connect_four/connect_four__parameters.png}

\includegraphics[width=.23\textwidth]{figures/rl/procgen/Procgen_StarPilot_width_compute.png}
\includegraphics[width=.22\textwidth]{figures/rl/procgen/Procgen_Heist.png}
\vspace{-3.0mm}
    \caption{
