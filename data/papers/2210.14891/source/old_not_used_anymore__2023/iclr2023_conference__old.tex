...
\includegraphics[width=.325\textwidth]{figures/rl/connect_four/connect_four__compute.png}
\includegraphics[width=.325\textwidth]{figures/rl/connect_four/connect_four__data.png}
\includegraphics[width=.325\textwidth]{figures/rl/connect_four/connect_four__parameters.png}
...
\noindent{\bf Acknowledgement.} We are thankful for useful feedback and assistance from Kartik Ahuja, Ibrahim Alabdulmohsin, Ankesh Anand, Jacob Buckman, Guillaume Dumas, Leo Gao, Andy Jones, Behnam Neyshabur, Gabriel Prato, Stephen Roller, Michael Trazzi, Tony Wu and others.
