...
In Section \ref{section:extrapolate_gpt4}, BNSL accurately extrapolates the scaling behavior of downstream performance to scales that are \textbf{over 100,000 times larger} than the max (along x-axis) of the points used for fitting.
...
\includegraphics[width=.305\textwidth]{figures/rl/connect_four/connect_four__compute.png}
\includegraphics[width=.305\textwidth]{figures/rl/connect_four/connect_four__data.png}
\includegraphics[width=.305\textwidth]{figures/rl/connect_four/connect_four__parameters.png}

\includegraphics[width=.32\textwidth]{figures/rl/procgen/Procgen_StarPilot_width_compute.png}
\includegraphics[width=.31\textwidth]{figures/rl/procgen/Procgen_Heist.png}
\vspace{-4.0mm}
    \caption{
...
\includegraphics[width=0.365\textwidth]{figures/double_descent/double_descent__model_size.png}
\includegraphics[width=0.365\textwidth]{figures/double_descent/double_descent__dataset_size_1.png}
\vspace{-4.0mm}
    \caption{
